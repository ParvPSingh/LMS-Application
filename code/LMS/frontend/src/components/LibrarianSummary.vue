<template>
    ...
    <br>
    <h3>Summary for <small class="text-body-secondary">Librarian</small></h3><br>
    ...
    <br><br>
    <h4>Distribution of <small class="text-body-secondary">Books Availability</small></h4>
    <img :src="imageSource1" alt="graph">
    <br>
    <h4>Distribution of <small class="text-body-secondary">All Active Requests</small></h4>
    <img :src="imageSource2" alt="graph">
    <br>
    <h4>Distribution of <small class="text-body-secondary">All Book Authors</small></h4>
    <img :src="imageSource3" alt="graph">
    <br>
    <h4>Distribution of <small class="text-body-secondary">All Book Genres</small></h4>
...
import LibrarianNavbar from './LibrarianNavbar.vue'
    export default{
        ...
        created(){
            ...
            this.image1 = 'graph_librarian_book_availability_dist.png';
            this.image2 = 'graph_librarian_active_requests.png',
            this.image3 = 'graph_librarian_book_authors_dist.png',
            this.image4 = 'graph_librarian_book_genres_dist.png'
        },
        computed: {
            imageSource1() {
        ...
        async mounted(){
            ...
            try {
                const response = await axios.get(`http://127.0.0.1:5000/api/sum`,{
                    headers: {
                        'Authentication-Token': this.token,
                    },
                });
